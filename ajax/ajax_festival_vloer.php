    ...
    <body>
        ...
        <h1>Festival Vloer</h1>
                ...
                <div class="checkhide">
                    ...
                    <label>
                        <input type="checkbox" id="fest_stenenstraat" name="straat" value="Stenen straat"/>
                        <label class="checkbox" for="fest_stenenstraat"><img src="img/stenen_straat.svg" /></label>
                        <p>Stenen straat</p>
                    </label>
                    <label>
                        <input type="checkbox" id="fest_asfalt" name="straat" value="Asfalt"/>
                        <label class="checkbox" for="fest_asfalt"><img src="img/asfalt.svg" /></label>
                        <p>Asfalt</p>
                    </label>
                    <label>
                        <input type="checkbox" id="fest_gras" name="straat" value="Gras"/>
                        <label class="checkbox" for="fest_gras"><img src="img/gras.svg" /></label>
                        <p>Gras</p>
                    </label>
                    <label>
                        <input type="checkbox" id="fest_grind" name="straat" value="Grind"/>
                        <label class="checkbox" for="fest_grind"><img src="img/grind.svg" /></label>
                        <p>Grind</p>
                    </label>
                    <label>
                        <input type="checkbox" id="fest_beton" name="straat" value="Beton"/>
                        <label class="checkbox" for="fest_beton"><img src="img/beton.svg" /></label>
                        <p>Beton</p>
                    </label>
                    <label>
                        <input type="checkbox" id="fest_strand" name="straat" value="Strand"/>
