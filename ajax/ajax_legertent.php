    ...
    <body>
        <h1>Legertent</h1> 
            ...
            <div class="checkhide">
                ...
                <label>
                    <input type="checkbox" id="leger_vlonders" name="leger_vloeren"/>
                    <label class="checkbox" for="leger_vlonders"><img src="img/vlonders.svg" /></label>
                    <p>Vlonders</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_zeil" name="leger_vloeren"/>
                    <label class="checkbox" for="leger_zeil"><img src="img/zeil.svg" /></label>
                    <p>Zeil</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_geenvloer" name="leger_vloeren"/>
            ...
            <div class="checkhide">
                ...
                <label>
                    <input type="checkbox" id="leger_opafbouwja" name="leger_op_afbouw"/>
                    <label class="checkbox" for="leger_opafbouwja"><img src="img/op_afbouw.svg" /></label>
                    <p>Op/Afbouw</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_opafbouwnee" name="leger_op_afbouw"/>
            ...
            <div class="checkhide">
                ...
                <label>
                    <input type="checkbox" id="leger_veldbed"/>
                    <label class="checkbox" for="leger_veldbed"><img src="img/veldbed.svg" /></label>
                    <p>Veldbed</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_slaapzak"/>
            ...
            <div class="checkhide">
                ...
                <label>
                    <input type="checkbox" id="leger_bezorgen" name="leger_transport"/>
                    <label class="checkbox" for="leger_bezorgen"><img src="img/bezorgen.svg" /></label>
                    <p>Bezorgen</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_afhalen" name="leger_transport"/>
            ...
            <div class="checkhide">
                ...
                <label>
                    <input type="checkbox" id="leger_stenenstraat" name="leger_ondergrond"/>
                    <label class="checkbox" for="leger_stenenstraat"><img src="img/stenen_straat.svg" /></label>
                    <p>Stenen Straat</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_asfalt" name="leger_ondergrond"/>
                    <label class="checkbox" for="leger_asfalt"><img src="img/asfalt.svg" /></label>
                    <p>Asfalt</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_gras" name="leger_ondergrond"/>
                    <label class="checkbox" for="leger_gras"><img src="img/gras.svg" /></label>
                    <p>Gras</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_grind" name="leger_ondergrond"/>
                    <label class="checkbox" for="leger_grind"><img src="img/grind.svg" /></label>
                    <p>Grind</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_beton" name="leger_ondergrond"/>
                    <label class="checkbox" for="leger_beton"><img src="img/beton.svg" /></label>
                    <p>Beton</p>
                </label>
                <label>
                    <input type="checkbox" id="leger_strand" name="leger_ondergrond"/>
            ...
            <div>
                <label>
                     <input class="geenharingen" type="checkbox" name="leger_haringen" value="geenharingen" />
